...
echo "************"
# Creating GIF
ffmpeg -f image2 -framerate 30 -pattern_type glob -i "$files" -vf scale=640:480 daily.gif
...
echo "************"
video_path='TBD'
#`/home/pi/day.zip/instagram/instagram -u ${INSTAGRAM_USER} -p ${INSTAGRAM_PASS} -f daily.mp4 -c "${quote} #insideklarna"`
